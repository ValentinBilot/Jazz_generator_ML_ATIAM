...
def TrainModel(model, print_every, plot_every, optimizer, lossFunction, model_type="lstm", alphabet='a0', sequence_lenght=16, using_cuda=True, batch_size=128, shuffle=True, num_workers=6, hidden_size=128, num_layers=2, dropout=0.1, learning_rate=1e-4, epochs=10):
	...
	all_losses, test_losses, accuracy_train, accuracy_test = doEpochs(model, model_type, epochs, print_every, plot_every, optimizer, lossFunction, learning_rate, batch_size, shuffle, num_workers, alphabet, sequence_lenght, device, training)
...
def TestModel(model, print_every, plot_every, optimizer, lossFunction, model_type="lstm", alphabet='a0', sequence_lenght=16, using_cuda=True, batch_size=128, shuffle=True, num_workers=6, hidden_size=128, num_layers=2, dropout=0.1, learning_rate=1e-4, epochs=10):
	...
	test_losses, accuracy_test = doEpochs(model, model_type, epochs, print_every, plot_every, optimizer, lossFunction, learning_rate, batch_size, shuffle, num_workers, alphabet, sequence_lenght, device, training)

	return sum(test_losses)/len(test_losses), sum(accuracy_test)/len(accuracy_test)
...
def doEpochs(model, model_type, epochs, print_every, plot_every, optimizer, lossFunction, learning_rate, batch_size, shuffle, num_workers, alphabet, sequence_lenght, device, training):
